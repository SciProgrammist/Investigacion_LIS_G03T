...
if(isset($_POST['button']) && isset($_FILES['attachment']))
{
	...
	$sender_name = 'Cliente'; //sender name
	$reply_to_email = $_POST["sender_email"]; //sender email, it will be used in "reply-to" header
	$subject	 = 'Reporte de Carrito de Compras'; //subject for the email
	$message	 ='Este es su reporte de compra, gracias por comprar en nuestra tienda.'; //body of the email
